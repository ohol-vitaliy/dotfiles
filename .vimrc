...
autocmd FileType cpp,c,h,hpp setlocal foldmethod=marker
autocmd FileType cpp,c,h,hpp setlocal foldmarker=#pragma\ region,#pragma\ endregion
autocmd FileType cpp,c,h,hpp setlocal foldlevel=1
autocmd FileType cpp,c,h,hpp normal zR

autocmd FileType sh,awk,java,javascript,typescript,json,css,php,conf setlocal foldmethod=marker
autocmd FileType sh,awk,java,javascript,typescript,json,css,php,conf setlocal foldmarker={,}
autocmd FileType sh,awk,java,javascript,typescript,json,css,php,conf setlocal foldlevel=20
autocmd FileType sh,awk,java,javascript,typescript,json,css,php,conf normal zR
...
let lspServers = [#{
	...
	\ 	pylsp: #{
	\ 		plugins: #{
	\ 			yapf: #{ enabled: v:true, column_limit: '1000' },
	\ 			jedi_completion: #{
	\ 				enabled: v:true,
	\ 				fuzzy: v:true,
...
if executable('ruff') || executable('pylsp')
	autocmd FileType python nnoremap K <Cmd>LspHover<CR>
	autocmd FileType python nnoremap L <Cmd>LspPeekReferences<CR>
	autocmd FileType python nnoremap H <Cmd>LspDocumentSymbol<CR>
	autocmd FileType python nnoremap <leader><space> <Cmd>LspDiagCurrent<CR>
	autocmd FileType python nnoremap <C-]> <Cmd>LspGotoDefinition<CR>
	autocmd FileType python nnoremap <leader>] <Cmd>LspGotoDefinition<CR>
	autocmd FileType python nnoremap <C-r><C-r> <Cmd>LspRename<CR>
	autocmd FileType python nnoremap <F2> <Cmd>LspRename<CR>
	autocmd FileType python nnoremap <C-f> <Cmd>LspFormat<CR>
endif
" }}}
" SuperTab {{{
